...
| Remote integration tools                                              | Local source or backing API/service layer         | Salesforce supports an explicit local service account source. Managed and other connector paths use the configured API layer. |
