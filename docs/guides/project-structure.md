...
For skills, the directory name is always the skill ID. New skills should repeat
that ID in the required frontmatter `name`; discovery treats a differing legacy
or display-style name only as presentation metadata. For example,
