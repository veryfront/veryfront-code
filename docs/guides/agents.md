...
Handlers scheduled by a later macrotask are not covered by this grace window
and can lose the race with the report. Synchronous throws also settle the
middleware invocation and revoke its continuation.
