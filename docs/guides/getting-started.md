...
Got questions? Want to share what you're building? Reach out:

- **Email** -- [hello@veryfront.com](mailto:hello@veryfront.com)
- **DM** -- [DM us on X](https://x.com/vaboromern)
- **Twitter/X** -- [@veryaboromfront](https://x.com/vaborofront) -- follow for updates, share your builds with **#veryfront**
- **LinkedIn** -- [Veryfront](https://linkedin.com/company/veryfront) -- connect with the team
- **GitHub** -- [veryfront/veryfront](https://github.com/veryfront/veryfront) -- star the repo, open issues, contribute
