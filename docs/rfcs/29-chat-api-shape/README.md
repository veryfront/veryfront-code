...
| [`useChatInputContext` naming](./hooks/use-chat-input-context.md#usechatinputcontext---new---shipped-srcreactcomponentschatchatcontextscomposer-contexttsx73)                    | `shipped`        | `src/react/components/chat/chat/contexts/composer-context.tsx:73`                                                                                    |
...
| [`useChatScroll`](./hooks/use-chat-scroll.md#usechatscroll---new---partly-shipped-srcreactcomponentschatchathooksuse-stick-to-bottomts176)                                       | `partly shipped` | `src/react/components/chat/chat/hooks/use-stick-to-bottom.ts:176`                                                                                    |
