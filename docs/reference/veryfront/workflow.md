...
| `WorkflowRunManager` | Workflow run manager backed by job executors | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/worker/job-manager.ts#L140)      |
...
| Name                                        | Description                                                         | Source                                                                                                             |
| ------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| `CreateDynamicWorkflowRunEntrypointOptions` | Options for a dynamic workflow run entrypoint                       | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/worker/dynamic-job-entrypoint.ts#L230) |
| `CreateWorkflowRunEntrypointOptions`        | Options for a workflow run entrypoint                               | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/worker/job-entrypoint.ts#L176)         |
...
| `JobExecutor`                               | Job executor interface for job-backed workflow runs                 | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/worker/executors/types.ts#L101)        |
