...
| `SafeJsonParseResult` | Tagged-union result of {@link safeJsonParse}; narrow via the `ok` discriminant. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/utils/json.ts#L7) |
| `SubscriberSet` | Listener registry returned by {@link createSubscriberSet}. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/utils/subscriber-set.ts#L1) |
