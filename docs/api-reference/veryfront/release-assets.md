...
| `runReleaseAssetBuild`                 | Execute a release asset build. Pure orchestration over the injected client and a runtime-provided temp dir + react version. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L2123) |
...
| `PreparedReleaseAsset`               | Prepared content-addressed asset bytes ready for upload.                                                                                                                                                                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L257)  |
...
| `ReleaseAssetBuildClient`            | Subset of the API client used by the builder (eases testing).                                                                                                                                                                 | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L201)  |
| `ReleaseAssetBuildInput`             | Inputs required to build and publish one release asset manifest generation.                                                                                                                                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L128)  |
| `ReleaseAssetBuildResult`            | Observable outcome of a release asset build attempt.                                                                                                                                                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L239)  |
...
| `ReleaseAssetHttpDependencyVendor`   | Injectable HTTP dependency vendoring contract.                                                                                                                                                                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L192)  |
...
| `ReleaseAssetTransform`              | Browser transform contract shared with the module-serving pipeline.                                                                                                                                                           | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L165)  |
| `ReleaseAssetVendorDependency`       | One vendored dependency and the source identity represented by its code.                                                                                                                                                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L174)  |
| `ReleaseAssetVendorResult`           | Rewritten module code plus every dependency needed by that rewrite.                                                                                                                                                           | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L186)  |
