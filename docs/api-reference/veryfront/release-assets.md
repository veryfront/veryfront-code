...
| `isValidContentHash` | Validate a content hash is exactly 64 lowercase hex characters. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/constants.ts#L108) |
...
| `releaseAssetUrl` | Map a 64-hex content hash + extension to its public asset URL. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/constants.ts#L79) |
...
| `runReleaseAssetBuild` | Execute a release asset build. Pure orchestration over the injected client and a runtime-provided temp dir + react version. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L2202) |
...
| `ReleaseAssetBuildInput` | Inputs required to build and publish one release asset manifest generation. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L136) |
| `ReleaseAssetBuildResult` | Observable outcome of a release asset build attempt. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L247) |
...
| `ReleaseAssetHttpDependencyVendor` | Injectable HTTP dependency vendoring contract. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L200) |
...
| `ReleaseAssetTransform` | Browser transform contract shared with the module-serving pipeline. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L173) |
| `ReleaseAssetVendorDependency` | One vendored dependency and the source identity represented by its code. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L182) |
| `ReleaseAssetVendorResult` | Rewritten module code plus every dependency needed by that rewrite. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/release-assets/build-executor.ts#L194) |
