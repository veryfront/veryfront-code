...
| `getTestTimeScale`       | Return the current test time scale. Preserved for compatibility.                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/testing/timing.ts#L3)                     |
