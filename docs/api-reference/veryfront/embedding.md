...
| `UploadAuthorize`           | Authorizer used by upload route handlers.               | [source](https://github.com/veryfront/veryfront-code/blob/main/src/embedding/upload-handler.ts#L91)    |
| `UploadAuthorizationResult` | Result returned by an upload authorizer.                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/embedding/upload-handler.ts#L89)    |
| `UploadHandlerAuthConfig`   | Authentication configuration for upload route handlers. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/embedding/upload-handler.ts#L95)    |
| `UploadHandlerConfig`       | Configuration used by createUploadHandler.              | [source](https://github.com/veryfront/veryfront-code/blob/main/src/embedding/upload-handler.ts#L99)    |
