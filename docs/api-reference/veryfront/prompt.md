...
|------|-------------|--------|
| `prompt` | Create a typed prompt definition. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/prompt/factory.ts#L23) |
...
| Name | Description | Source |
|------|-------------|--------|
| `promptRegistry` | Project-scoped prompt registry value. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/prompt/registry.ts#L48) |
