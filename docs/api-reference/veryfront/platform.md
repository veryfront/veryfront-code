...
| ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| `createCacheDependencySnapshotStoreHandle` | Build the opaque handle for cache-backed shared snapshot history.                                                                                                                                                       | [source](https://github.com/veryfront/veryfront-code/blob/main/src/cache/dependency-snapshot-store.ts)             |
| `createDependencySnapshotStoreHandle`      | Capture a provider for RuntimeAdapter without placing its methods in renderer state.                                                                                                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/dependency-snapshot-store.ts) |
...
| `DependencySnapshotRecord`      | Serialized immutable snapshot and its acknowledged retention deadline.                                                                                                                                                                 | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/dependency-snapshot-store.ts) |
| `DependencySnapshotStore`       | Host-owned shared snapshot storage. Implementations must authorize access, bound reads to 1 MiB, and reject publication unless retention is acknowledged. A node-local cache does not satisfy this capability for replicated runtimes. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/dependency-snapshot-store.ts) |
| `DependencySnapshotStoreHandle` | Opaque host storage reference. It exposes no privileged read or publish methods.                                                                                                                                                       | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/dependency-snapshot-store.ts) |
