...
| `isExtendedFSAdapter`       |                                                                                                                                                                                                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/fs/wrapper.ts#L135)         |
...
| `VeryfrontApiClient` |                                                                                                                                        | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/veryfront-api-client/client.ts#L42) |
...
### `veryfront/platform/dynamic-import`

Opaque dynamic import helper. Uses `new Function` to hide the `import()` call from static analysis by bundlers and `deno compile`, preventing them from tracing into the imported specifier.
...
| Name            | Description                   | Source                                                                                                    |
| --------------- | ----------------------------- | --------------------------------------------------------------------------------------------------------- |
| `dynamicImport` | Opaque dynamic import helper. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/dynamic-import.ts#L11) |
...
} from "veryfront/platform/runtime";
```
...
| Name                        | Description                                                                                                                                                                                                               | Source                                                                                              |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `classifyRuntimeSignals`    |                                                                                                                                                                                                                           | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L9)   |
| `getDenoRuntime`            |                                                                                                                                                                                                                           | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L33)  |
| `isBrowserEnvironment`      | Detect if code is executing in a browser environment. Inverse of isServerEnvironment() - use this instead of `typeof window !== "undefined"`.                                                                             | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L153) |
| `isNodeRuntime`             | Detect if running in Node.js (vs Deno) at call time. Use this function instead of the constant when runtime detection needs to happen at call time (e.g., when bundled with esbuild's __esm lazy initialization pattern). | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L117) |
| `isServerEnvironment`       | Detect if code is executing in a server environment (SSR).                                                                                                                                                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L140) |
| `testDenoCompiledDetection` | Check if an executable path is a compiled Deno binary. Detects by binary name: "deno" or "deno.exe" = standard runtime, anything else = compiled.                                                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L55)  |

#### Types

| Name          | Description | Source                                                                                            |
| ------------- | ----------- | ------------------------------------------------------------------------------------------------- |
| `RuntimeKind` |             | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L6) |
...
| `isCloudflare`   | True if running in Cloudflare Workers, including nodejs_compat workers.                                                                                                           | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L97)  |
| `isDeno`         | True if running in the real Deno runtime rather than a dnt shim.                                                                                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L103) |
| `isDenoCompiled` | True if running in a compiled Deno binary. Compiled binaries cannot dynamically import HTTP URLs - they must use local file:// paths. This is evaluated once at module load time. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L110) |
...
| `runtimeKind`    |                                                                                                                                                                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/runtime.ts#L86)  |
