...
```ts
import { requireRateLimitKey, requireRateLimitWindowMs, unrefTimer } from "veryfront/extensions/distributed/rate-limit-support";
```
...
| Name | Description | Source |
|------|-------------|--------|
| `MAX_RATE_LIMIT_KEY_LENGTH` |  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/middleware/builtin/security/rate-limit-validation.ts#L4) |
...
| `REDIS_RATE_LIMIT_INCREMENT_WITH_TTL_SCRIPT` |  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/middleware/builtin/security/redis-rate-limit-script.ts#L1) |
