...
| `captureRedisRuntimeProvider`    | Validate and snapshot a provider before core invokes extension-owned code. Accessors are rejected so registration cannot execute code during capture.                                                                            | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/distributed/redis-runtime-provider.ts#L501) |
...
| `formatInstallCommand`           | Return the command that installs `packageName` with `target`.                                                                                                                                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/install-command.ts#L139)                    |
...
| `runtimeInstallTarget`           | Return the client that ships with `runtime`.                                                                                                                                                                                     | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/install-command.ts#L124)                    |
...
| `InstallTarget`                  | Package client that owns a project's dependencies.                                                                 | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/install-command.ts#L51)                     |
...
| `RedisRuntimeProvider`           | Optional Redis runtime implementation supplied by an extension.                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/distributed/redis-runtime-provider.ts#L160) |
...
| `readTypeScriptDecoratorOptions` | Resolve the two legacy-decorator flags from a TypeScript configuration.                                                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/typescript-config.ts#L160) |
...
| Name                                  | Description                                                                                  | Source                                                                                                          |
| ------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `BuildContext`                        | Incremental/rebuild context produced by `Bundler.context`.                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L268)          |
| `BuildFailure`                        | Failure thrown by `Bundler.bundle` or `Bundler.transform`.                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L278)          |
...
| `BuildResult`                         | Result returned from `Bundler.bundle`.                                                       | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L126)          |
...
| `BundleOutput`                        | A single output file produced by a bundle operation.                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L114)          |
| `Bundler`                             | Bundler contract interface.                                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L289)          |
| `BundleResult`                        | Result returned from `Bundler.bundle`.                                                       | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L126)          |
...
| `BundlerPlugin`                       | A bundler plugin that hooks into the build pipeline.                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L260)          |
| `BundlerPluginBuild`                  | Build context exposed to bundler plugins.                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L233)          |
...
| `Loader`                              | Loader hint for source files. Mirrors esbuild's `Loader` type.                               | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L138)          |
...
| `OnLoadArgs`                          | Arguments passed to an `onLoad` callback.                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L214)          |
| `OnLoadResult`                        | Result returned from an `onLoad` callback.                                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L222)          |
| `OnResolveArgs`                       | Arguments passed to an `onResolve` callback.                                                 | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L191)          |
| `OnResolveResult`                     | Result returned from an `onResolve` callback.                                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L202)          |
| `Plugin`                              | A bundler plugin that hooks into the build pipeline.                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L260)          |
| `PluginBuild`                         | Build context exposed to bundler plugins.                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L233)          |
| `ReadTypeScriptDecoratorOptionsInput` | Input for `readTypeScriptDecoratorOptions`.                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/typescript-config.ts#L51) |
| `ResolveResult`                       | Result returned from an `onResolve` callback.                                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L202)          |
...
| `TransformOptions`                    | Options passed to `Bundler.transform`.                                                       | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L155)          |
| `TransformResult`                     | Result returned from `Bundler.transform`.                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L181)          |
| `TypeScriptDecoratorOptions`          | Compiler flags that control legacy TypeScript decorator transformation.                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/bundler.ts#L303)          |
...
| `RedisClient`                       | Structural client surface used by core cache features.              | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/distributed/redis-runtime-provider.ts#L96)  |
| `RedisClientHandle`                 | Independently owned Redis connection returned to a core feature.    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/distributed/redis-runtime-provider.ts#L126) |
| `RedisClientOptions`                | Connection options accepted by the stable core Redis client facade. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/distributed/redis-runtime-provider.ts#L132) |
...
| `RedisEventPublisherImplementation` | Redis-backed event publisher/subscriber implementation.             | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/distributed/redis-runtime-provider.ts#L152) |
| `RedisRuntimeProvider`              | Optional Redis runtime implementation supplied by an extension.     | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/distributed/redis-runtime-provider.ts#L160) |
...
| `parseSerializedCachePayload`             | Reject oversized or malformed JSON before constructing an untrusted object graph.                                                                                                                                       | [source](https://github.com/veryfront/veryfront-code/blob/main/src/rendering/cache/cache-payload.ts#L1074)      |
...
| `serializeCachePayload`                   | Serialize using the origin-compatible payload shape.                                                                                                                                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/rendering/cache/cache-payload.ts#L1004)      |
...
| `unrefTimer`               | Unreference a timer to prevent it from keeping the process alive | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/process/lifecycle.ts#L313)                |
...
| `parseProxyRoutingInvalidationEvent`  |                                                            | [source](https://github.com/veryfront/veryfront-code/blob/main/src/proxy/routing-invalidation.ts#L327) |

#### Types

| Name                                    | Description | Source                                                                                                |
| --------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------- |
| `ProxyRoutingInvalidationEvent`         |             | [source](https://github.com/veryfront/veryfront-code/blob/main/src/proxy/routing-invalidation.ts#L35) |
| `ProxyRoutingInvalidationPublisher`     |             | [source](https://github.com/veryfront/veryfront-code/blob/main/src/proxy/routing-invalidation.ts#L45) |
| `ProxyRoutingInvalidationPublishResult` |             | [source](https://github.com/veryfront/veryfront-code/blob/main/src/proxy/routing-invalidation.ts#L39) |
