...
| `readTypeScriptDecoratorOptions` | Resolve the two legacy-decorator flags from a TypeScript configuration.                                                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/typescript-config.ts#L124) |
...
| `ReadTypeScriptDecoratorOptionsInput` | Input for `readTypeScriptDecoratorOptions`.                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/extensions/bundler/typescript-config.ts#L36) |
