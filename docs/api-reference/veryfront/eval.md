...
| `EvalProgressEvent`                   | Progress notification emitted by `runEval` while it executes records.                                                                                              | [source](https://github.com/veryfront/veryfront-code/blob/main/src/eval/types.ts)     |
...
| `EvalToolInputContext`                | Context passed to an `evalTool` input mapper.                                                                                                                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/eval/types.ts)     |
