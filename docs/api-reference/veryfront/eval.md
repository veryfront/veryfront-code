...
| `evalDataset`                       | Define a target-free eval that grades each stored dataset example directly.                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/eval/factory.ts#L120)          |
...
| `isEvalDefinition`                  | Check whether a value is a normalized eval definition.                                                     | [source](https://github.com/veryfront/veryfront-code/blob/main/src/eval/factory.ts#L128)          |
...
| `EvalDatasetInput`                    | Input accepted by `evalDataset`. Dataset evals grade each stored example value directly, so they have no execution target; the report identity is the stable `id`. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/eval/types.ts#L429)    |
