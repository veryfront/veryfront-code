...
| `isProxyWithoutHooks`               | Identify a Proxy without evaluating any trap on the proxied value.                                                                                                                                                                                                                                                                                                                              | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/compat/error-introspection.ts#L337)                |
...
| `parseRetryAfterMs`                 | Parses retry after ms.                                                                                                                                                                                                                                                                                                                                                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/provider/runtime-loader/provider-http.ts#L198)              |
