...
| `getConnector` | Return a visible connector after trimming and case-normalizing its name. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/integrations/index.ts#L80) |
| `getConnectorNames` | Return connector names. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/integrations/index.ts#L93) |
| `getIcon` | Return a visible connector's icon after trimming and case-normalizing its name. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/integrations/index.ts#L98) |
...
| `listConnectors` | List visible connectors backed by deeply frozen catalog metadata. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/integrations/index.ts#L88) |
