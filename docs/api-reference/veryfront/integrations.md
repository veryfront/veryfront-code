...
| `IntegrationCallOptions`                    | Optional selection metadata, separate from native provider arguments.                                                                                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/integrations/client-types.ts)               |
