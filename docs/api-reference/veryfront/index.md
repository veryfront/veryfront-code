...
| `DataContext`              | Context passed to `getServerData()`.                                                                                                                                                        | [source](https://github.com/veryfront/veryfront-code/blob/main/src/data/schemas/data.schema.ts#L94)          |
| `DataResponseMetadata`     | Custom document response metadata returned from `getServerData()`.                                                                                                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/data/schemas/data.schema.ts#L99)          |
| `DataResult`               | Props, routing control, caching, and response metadata returned from `getServerData()`.                                                                                                     | [source](https://github.com/veryfront/veryfront-code/blob/main/src/data/schemas/data.schema.ts#L104)         |
...
| `ResponseCookie`           | One cookie emitted as a distinct Set-Cookie response field.                                                                                                                                 | [source](https://github.com/veryfront/veryfront-code/blob/main/src/data/schemas/data.schema.ts#L97)          |
...
| `StaticDataResult`         | Cache-safe result returned from `getStaticData()`.                                                                                                                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/data/schemas/data.schema.ts#L108)         |
| `StaticPathsResult`        | Return type for `getStaticPaths()`.                                                                                                                                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/data/schemas/data.schema.ts#L119)         |
