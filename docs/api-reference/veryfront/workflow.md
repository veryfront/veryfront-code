...
| `deriveRunEvents`          | Events describing how a run got from `previous` to `next`.                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L206)                  |
...
| `isTerminalRunStatus`      | Whether a run in this status can still produce events.                                              | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L82)                   |
...
| `parseDuration`            | Parse duration string to milliseconds                                                               | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/types.ts#L498)                   |
...
| `snapshotRun`              | Reduce a run to the state `deriveRunEvents` compares.                                               | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L156)                  |
...
| `RunEventSnapshot`            | The slice of a run this module diffs against.                                                                                                                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L150)                     |
...
| `WorkflowRunEvent`            | A persisted workflow transition suitable for streaming to run observers.                                                                                           | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L134)                     |
| `WorkflowRunEventObservation` | Subscriber-local event stream derived from one atomic backend observation.                                                                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L238)                     |
...
| `WorkflowRunStatusEvent`      | The run as a whole moved to a new status.                                                                                                                          | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L119)                     |
...
| `WorkflowStepCompletedEvent`  | A step finished successfully.                                                                                                                                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L95)                      |
| `WorkflowStepFailedEvent`     | A step failed. `error` is the persisted message, absent when none was set.                                                                                         | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L103)                     |
| `WorkflowStepSkippedEvent`    | A step was skipped, typically by an unmet branch condition.                                                                                                        | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L112)                     |
| `WorkflowStepStartedEvent`    | A step began executing.                                                                                                                                            | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/events.ts#L87)                      |
