...
| `PublishEventOutcome`          | What `publishEvent` did with an event.                                                                                                                                                                                                                                                                                                                                                                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/runtime/event-wait-manager.ts#L76)  |
