...
| `RedisBackend`     | Implement redis backend.   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/backends/redis/index.ts#L743)       |
...
| `PublishEventOutcome`          | What `publishEvent` did with an event.                                                                                                                             | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/runtime/event-wait-manager.ts#L47)  |
