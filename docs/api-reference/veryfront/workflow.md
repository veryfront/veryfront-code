...
| `RedisAdapter` | Adapter interface that normalizes differences between Deno and Node Redis clients. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/redis/interface.ts#L2) |
...
| `createEventPublisher` | Create an event publisher based on environment | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/claude-code/event-publisher.ts#L290) |
...
| `CallbackEventPublisher` | Callback-based publisher that calls a function for each event. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/claude-code/event-publisher.ts#L231) |
