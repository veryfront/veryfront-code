...
| `TerminalRunRetentionBatch`       | Bounded oldest-first terminal snapshots returned by a retention backend.                                                                                                                                                                                                                                                                                                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/backends/types.ts)             |
...
| `WorkflowQueueDelivery`           | Queue work returned for processing, with an optional backend-scoped receipt.                                                                                                                                                                                                                                                                                                                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/backends/types.ts)             |
