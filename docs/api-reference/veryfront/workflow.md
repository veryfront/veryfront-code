...
| `hasEventWaitSupport`      | Check whether durable event waits are available.                                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/backends/types.ts#L669)          |
| `hasRunObservationSupport` | Check whether atomic run observation is available.                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/backends/types.ts#L617)          |
| `hasWorkerSupport`         | Check whether worker support is present.                                                            | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/backends/types.ts#L713)          |
