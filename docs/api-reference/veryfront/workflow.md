...
| `RedisAdapter` | Adapter interface that normalizes differences between Deno and Node Redis clients. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/platform/adapters/redis/interface.ts#L4) |
...
```ts
import { assertSafeBlobId, isSafeBlobId, LocalBlobStorage } from "veryfront/workflow/blob";
```
...
| `createEventPublisher` | Create an event publisher based on environment | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/claude-code/event-publisher.ts#L296) |
...
| `CallbackEventPublisher` | Callback-based publisher that calls a function for each event. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/claude-code/event-publisher.ts#L237) |
| `MemoryEventPublisher` | In-memory EventTarget publisher for testing or single-process deployments. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/claude-code/event-publisher.ts#L52) |
| `MultiEventPublisher` | Publishes events to multiple publishers | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/claude-code/event-publisher.ts#L256) |
...
| `SSEEventPublisher` | Server-Sent Events publisher that writes events directly to a ReadableStream controller. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/workflow/claude-code/event-publisher.ts#L155) |
