...
| `API_CLIENT_ERROR`                     | API client request/response errors (replaces VeryfrontAPIError)                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L91)      |
...
| `CACHE_INVARIANT_VIOLATION`            | Cache path invariant violations (replaces CacheInvariantError)                                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L109)     |
| `CACHE_PATH_MISMATCH`                  |                                                                                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L74)      |
| `CIRCUIT_BREAKER_OPEN`                 |                                                                                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L66)      |
...
| `FALLBACK_EXHAUSTED`                   | Both primary and fallback operations failed (replaces FallbackExecutionError)                                    | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L127)     |
...
| `NETWORK_ERROR`                        |                                                                                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L82)      |
...
| `PROJECT_EXECUTION_UNAVAILABLE`        |                                                                                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L50)      |
...
| `RAG_STORE_CORRUPT`                    | Persisted RAG index is malformed or failed structural validation.                                                | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L136)     |
| `RAG_STORE_UNAVAILABLE`                | A persisted RAG index operation could not be completed safely.                                                   | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L145)     |
...
| `RELEASE_NOT_FOUND`                    | Production domain resolved but no active release found                                                           | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L118)     |
...
| `SEMAPHORE_TIMEOUT`                    |                                                                                                                  | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L58)      |
...
| `TOKEN_STORAGE_ERROR`                  | Token storage adapter failures (replaces TokenStorageError)                                                      | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/server.ts#L100)     |
