...
| `TRIGGER_EXECUTION_FAILED` | Trigger target failed during local execution. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/runtime.ts#L78) |
| `TRIGGER_NOT_SUPPORTED` | Trigger target type is not supported in the current runtime context | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/runtime.ts#L87) |
| `TRIGGER_TARGET_NOT_FOUND` | Trigger target not found during local execution. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/runtime.ts#L69) |
...
| `WORKFLOW_RUN_CONFLICT` | A workflow run cannot be created because its immutable id is already present. | [source](https://github.com/veryfront/veryfront-code/blob/main/src/errors/error-registry/runtime.ts#L60) |
