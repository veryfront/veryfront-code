...
2. **Pick ONE red row** from the coverage suite — the highest-leverage failing
   ...
   consult or maintain; only reach for `/to-spec` + `/to-tickets` if you're adding a
   piece that isn't already an enumerated row.
...
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Scope in _(only for NEW scope)_ | **`/to-spec`** → **`/to-tickets`**                                                                                      | Skip in the normal loop — the spec/tickets already exist and the coverage tests are the live definition-of-done. Only run these to add a piece not yet in the matrix. Markdown only, no `gh`.                                                                                                                                                                                                                                                                                                     |
