...
import { getRedisClient, isRedisConfigured, type RedisClient } from "../utils/redis-client.js";
import { runtime } from "../platform/adapters/registry.js";
import { tryGetCacheKeyContext } from "./cache-key-builder.js";
import { getRuntimeEnv, isRuntimeEnvInitialized, type RuntimeEnv } from "../config/runtime-env.js";
...
function getCurrentRequestContext(): { token?: string } | null {
  ...
  const mod = (dntShim.dntGlobalThis as any).__vf_multi_project_adapter;
