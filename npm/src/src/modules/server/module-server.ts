...
export function serveModule(req: dntShim.Request, options: ModuleServerOptions): Promise<dntShim.Response> {
 ...
 */
export function isModuleRequest(req: dntShim.Request): boolean {
  const url = new URL(req.url);
