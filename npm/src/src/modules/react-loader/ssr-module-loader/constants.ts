...
const envLimit = (dntShim.dntGlobalThis as any).Deno?.env?.get("SSR_TRANSFORM_PER_PROJECT_LIMIT") ??
  // deno-lint-ignore no-explicit-any
  (dntShim.dntGlobalThis as any).process?.env?.SSR_TRANSFORM_PER_PROJECT_LIMIT;
