...
import type { CacheAdapter, LRUCacheOptions, LRUCacheStats, LRUEntry } from "./types.js";
...
function estimateSizeRecursive(value: unknown, depth: number, seen: WeakSet<object>): number {
  ...
  if (typeof dntShim.Blob !== "undefined" && value instanceof dntShim.Blob) return value.size;
