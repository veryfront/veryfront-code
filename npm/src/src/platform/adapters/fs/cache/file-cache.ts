...
import type { CacheEntry, CacheStats, FileCacheOptions } from "./types.js";
import { estimateSize } from "./size-estimator.js";
// Direct import to avoid circular dependency through cache/index.ts barrel
import { type CacheBackend, CacheBackends, MemoryCacheBackend } from "../../../../cache/backend.js";
import {
  getCachedWithBatching,
  setInRequestCache,
} from "../../../../cache/request-cache-batcher.js";
