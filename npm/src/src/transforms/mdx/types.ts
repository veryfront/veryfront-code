...
export interface MDXFrontmatter {
  ...
  scripts?: Array<{ src?: string; content?: string; [key: string]: string | undefined }>;
  styles?: Array<{ href?: string; content?: string; [key: string]: string | undefined }>;
  viewport?: string;
  themeColor?: string;
  [key: string]: unknown;
}
