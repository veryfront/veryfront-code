...
export class VeryfrontRouter {
  ...
  init(): void {
    ...
    const ReactDOMToUse = (dntShim.dntGlobalThis as GlobalWithReactDOM).ReactDOM || ReactDOM;
...
if (typeof dntShim.dntGlobalThis !== "undefined" && globalThis.document) {
  ...
  (dntShim.dntGlobalThis as unknown as GlobalWithRouter).veryFrontRouter = router;
}
