...
export function instrumentErrorHandler(
  handler: (error: Error, request?: dntShim.Request) => Promise<dntShim.Response> | dntShim.Response,
  captureToSpan = true,
): (error: Error, request?: dntShim.Request) => Promise<dntShim.Response> | dntShim.Response {
  return (error: Error, request?: dntShim.Request): Promise<dntShim.Response> | dntShim.Response => {
...
function captureErrorToSpan(error: Error, request?: dntShim.Request): void {
