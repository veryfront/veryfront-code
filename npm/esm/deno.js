export default {
    ...
    "exports": {
        ...
        "./router": "./src/react/router/index.ts",
        "./context": "./src/react/context/index.ts",
        "./fonts": "./src/react/fonts/index.ts",
        "./react": "./src/react/index.ts",
        "./react/components": "./src/react/components/index.ts",
        "./react/components/ai": "./src/react/components/ai/index.ts",
        "./react/primitives": "./src/react/primitives/index.ts",
        "./react/context": "./src/react/context/index.ts",
        "./react/router": "./src/react/router/index.ts",
        "./react/fonts": "./src/react/fonts/index.ts",
        "./react/head": "./src/react/components/Head.tsx",
        "./data": "./src/data/index.ts",
        "./config": "./src/config/index.ts",
        "./platform": "./src/platform/index.ts",
        "./tool": "./src/tool/index.ts",
        "./tool/schema": "./src/tool/schema/index.ts",
        "./tool/testing": "./src/tool/testing/index.ts",
        "./provider": "./src/provider/index.ts",
        "./provider/adapters": "./src/provider/adapters/index.ts",
        "./agent": "./src/agent/index.ts",
        "./agent/react": "./src/agent/react/index.ts",
        "./agent/react/client": "./src/agent/react/client.ts",
        "./agent/memory": "./src/agent/memory/index.ts",
        "./agent/composition": "./src/agent/composition/index.ts",
        "./agent/middleware": "./src/agent/middleware/index.ts",
        "./agent/testing": "./src/agent/testing/index.ts",
        "./agent/debug": "./src/agent/debug/index.ts",
        "./workflow": "./src/workflow/index.ts",
        "./workflow/react": "./src/workflow/react/index.ts",
        "./prompt": "./src/prompt/index.ts",
        "./resource": "./src/resource/index.ts",
        "./mcp": "./src/mcp/index.ts",
        "./oauth": "./src/oauth/index.ts",
        "./oauth/providers": "./src/oauth/providers/index.ts",
        "./oauth/handlers": "./src/oauth/handlers/index.ts",
        "./oauth/token-store": "./src/oauth/token-store/index.ts",
        "./embeddings": "./src/embeddings/index.ts"
    },
    "imports": {
        "veryfront/head": "./src/react/components/Head.tsx",
        "veryfront/router": "./src/react/router/index.ts",
        "veryfront/context": "./src/react/context/index.ts",
        "veryfront/fonts": "./src/react/fonts/index.ts",
        "veryfront/react/head": "./src/react/components/Head.tsx",
        "veryfront/react/router": "./src/react/router/index.ts",
        "veryfront/react/context": "./src/react/context/index.ts",
        ...
        "#veryfront/cli/ui": "./src/cli/ui/index.ts",
        ...
        "#veryfront/types": "./src/types/index.ts",
        "#veryfront/utils": "./src/utils/index.ts",
        "#veryfront/workflow": "./src/workflow/index.ts",
        "#veryfront/workflow/react": "./src/workflow/react/index.ts",
        "#veryfront/embeddings": "./src/embeddings/index.ts",
        ...
        "#veryfront/compat/http": "./src/platform/compat/http/index.ts",
        "#veryfront/compat/kv": "./src/platform/compat/kv/index.ts",
        "#veryfront/compat/path": "./src/platform/compat/path/index.ts",
        "#veryfront/compat/": "./src/platform/compat/",
        "#veryfront/http/": "./src/platform/compat/http/",
        ...
        "@veryfront/middleware": "./src/middleware/index.ts",
        "@veryfront/modules": "./src/modules/index.ts",
        "@veryfront/oauth": "./src/oauth/index.ts",
        "@veryfront/observability": "./src/observability/index.ts",
        "@veryfront/platform": "./src/platform/index.ts",
        "@veryfront/prompt": "./src/prompt/index.ts",
        "@veryfront/provider": "./src/provider/index.ts",
        ...
        "#std/path.ts": "https://deno.land/std@0.220.0/path/mod.ts",
        "#std/assert": "https://deno.land/std@0.220.0/assert/mod.ts",
        "#std/assert.ts": "https://deno.land/std@0.220.0/assert/mod.ts",
        "#std/dotenv": "https://deno.land/std@0.220.0/dotenv/mod.ts",
        "#std/dotenv.ts": "https://deno.land/std@0.220.0/dotenv/mod.ts",
        "#std/flags": "https://deno.land/std@0.220.0/flags/mod.ts",
        "#std/flags.ts": "https://deno.land/std@0.220.0/flags/mod.ts",
        "#std/fmt/colors": "https://deno.land/std@0.220.0/fmt/colors.ts",
        "#std/fmt/colors.ts": "https://deno.land/std@0.220.0/fmt/colors.ts",
        "#std/testing": "https://deno.land/std@0.220.0/testing/mod.ts",
        "#std/testing.ts": "https://deno.land/std@0.220.0/testing/mod.ts",
        ...
        "#std/expect.ts": "https://deno.land/std@0.220.0/expect/mod.ts",
        "#std/fs": "https://deno.land/std@0.220.0/fs/mod.ts",
        "#std/fs.ts": "https://deno.land/std@0.220.0/fs/mod.ts",
        "#std/async": "https://deno.land/std@0.220.0/async/mod.ts",
        "#std/async.ts": "https://deno.land/std@0.220.0/async/mod.ts",
    ...
    "tasks": {
        ...
        "test:unit": "VF_DISABLE_LRU_INTERVAL=1 SSR_TRANSFORM_PER_PROJECT_LIMIT=0 REVALIDATION_PER_PROJECT_LIMIT=0 NODE_ENV=production LOG_FORMAT=text deno test --no-check --parallel --allow-all --v8-flags=--max-old-space-size=8192 '--ignore=tests,src/ai/workflow/__tests__,src/cli/commands/*.integration.test.ts' --unstable-worker-options --unstable-net",
        "test:integration": "VF_DISABLE_LRU_INTERVAL=1 SSR_TRANSFORM_PER_PROJECT_LIMIT=0 REVALIDATION_PER_PROJECT_LIMIT=0 NODE_ENV=production LOG_FORMAT=text deno test --no-check --parallel --allow-all tests --unstable-worker-options --unstable-net",
        "test:integration:cli": "VF_DISABLE_LRU_INTERVAL=1 SSR_TRANSFORM_PER_PROJECT_LIMIT=0 REVALIDATION_PER_PROJECT_LIMIT=0 NODE_ENV=production LOG_FORMAT=text deno test --no-check --parallel --allow-all src/cli/commands/*.integration.test.ts --unstable-worker-options --unstable-net",
        "test:record": "VCR=record deno test --no-check --allow-all src/cli/commands/*.integration.test.ts",
        "test:coverage": "rm -rf coverage && VF_DISABLE_LRU_INTERVAL=1 SSR_TRANSFORM_PER_PROJECT_LIMIT=0 REVALIDATION_PER_PROJECT_LIMIT=0 NODE_ENV=production LOG_FORMAT=text deno test --no-check --parallel --fail-fast --allow-all --coverage=coverage --unstable-worker-options --unstable-net || exit 1",
        "test:coverage:unit": "rm -rf coverage && VF_DISABLE_LRU_INTERVAL=1 SSR_TRANSFORM_PER_PROJECT_LIMIT=0 REVALIDATION_PER_PROJECT_LIMIT=0 NODE_ENV=production LOG_FORMAT=text deno test --no-check --parallel --fail-fast --allow-all --coverage=coverage '--ignore=tests,src/ai/workflow/__tests__,src/cli/commands/*.integration.test.ts' --unstable-worker-options --unstable-net || exit 1",
        "test:coverage:integration": "rm -rf coverage && VF_DISABLE_LRU_INTERVAL=1 SSR_TRANSFORM_PER_PROJECT_LIMIT=0 REVALIDATION_PER_PROJECT_LIMIT=0 NODE_ENV=production LOG_FORMAT=text deno test --no-check --parallel --fail-fast --allow-all --coverage=coverage tests --unstable-worker-options --unstable-net || exit 1",
        ...
        "test:node": "node ./scripts/run-node-tests.mjs 'src/**/*.test.ts'",
        "test:bun": "node ./scripts/run-bun-tests.mjs src/",
        ...
        "batch:status": "deno run -A scripts/batch-simplify/batch-simplify.ts status",
        "batch:errors": "deno run -A scripts/batch-simplify/batch-simplify.ts errors",
        "batch:download": "deno run -A scripts/batch-simplify/batch-simplify.ts download",
