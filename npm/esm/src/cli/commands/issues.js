...
import { createIssuesManager, parseState } from "../../issues/index.js";
/**
...
function getJsonFlag(args) {
    return Boolean(args.json || args.j);
}
function getId(args, index) {
...
export async function issuesCommand(args) {
    ...
    switch (subcommand) {
        case "create": {
            ...
            const prefix = (args.prefix?.toUpperCase() || "ISSUE");
        ...
        case "ls": {
            ...
            const sortBy = args.sort || "created_at";
            const sortDirection = args.dir || "desc";
