...
export async function createShimFile(outDir) {
...
export async function createBuildContext(options, entryPoints) {
    const moduleResolution = options.moduleResolution ?? "cdn";
    const externalDependencies = getExternalDependencies(options.external, moduleResolution);
