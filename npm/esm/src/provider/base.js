...
export class BaseProvider {
    ...
    async complete(request) {
        const response = await this.postChatCompletions(this.transformRequest({ ...request, stream: false }));
    ...
    async stream(request) {
        const response = await this.postChatCompletions(this.transformRequest({ ...request, stream: true }));
        if (response.body)
