...
export class AnthropicProvider extends BaseProvider {
    ...
    transformRequest(request) {
        ...
        agentLogger.debug("Anthropic transformRequest - transformed messages:", JSON.stringify(transformedMessages, null, 2));
        const body = {
            model: request.model,
                            ...
                            try {
                                ...
                                if (parsed.type === "content_block_delta") {
                                    ...
                                    if (delta?.type === "text_delta" && delta.text) {
                                        controller.enqueue(encoder.encode(JSON.stringify({ type: "content", content: delta.text }) + "\n"));
                                    }
