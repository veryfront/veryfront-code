...
export function injectElementSelectors(html, options = {}) {
    ...
    return html.replace(/<(\/?)?([a-zA-Z][a-zA-Z0-9-]*)((?:\s+[^>]*)?)\/?>/g, (match, isClosing, tagName, attributes = "", offset) => {
        ...
        const insertPoint = match.lastIndexOf(isVoid || isSelfClosing ? (isSelfClosing ? "/>" : ">") : ">");
...
export function isStudioEmbed(url) {
