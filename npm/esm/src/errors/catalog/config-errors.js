...
export default {
  ...
  dev: {
    ...
    [ErrorCode.CONFIG_PARSE_ERROR]: createSimpleError(ErrorCode.CONFIG_PARSE_ERROR, "Configuration parse error", "Failed to parse your configuration file.", [
    ...
    [ErrorCode.CONFIG_VALIDATION_ERROR]: createSimpleError(ErrorCode.CONFIG_VALIDATION_ERROR, "Configuration validation failed", "Configuration values do not pass validation.", [
    ...
    [ErrorCode.CONFIG_TYPE_ERROR]: createSimpleError(ErrorCode.CONFIG_TYPE_ERROR, "Configuration type error", "A configuration value has the wrong type.", [
