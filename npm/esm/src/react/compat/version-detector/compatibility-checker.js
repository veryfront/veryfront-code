...
const REACT_19_FEATURES = new Set([
    "useFormStatus",
    "useOptimistic",
    "serverActions",
    "improvedSuspense",
...
const REACT_18_FEATURES = new Set([
    "streaming",
    "transitions",
    "suspense",
    "automaticBatching",
...
export function checkVersionCompatibility(requiredFeatures) {
...
export function getRecommendedSSRMethod() {
