 ...
 */
export interface OpenAPIRouteConfig<TParams extends z.ZodTypeAny = z.ZodTypeAny, TQuery extends z.ZodTypeAny = z.ZodTypeAny, TBody extends z.ZodTypeAny = z.ZodTypeAny> {
    summary?: string;
    description?: string;
    tags?: string[];
    params?: TParams;
