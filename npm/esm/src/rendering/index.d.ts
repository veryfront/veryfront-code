...
export { getCompiledSnippet, renderSnippet, type SnippetRenderOptions, type SnippetRenderResult, } from "./snippet-renderer.js";
import { type RendererOptions, VeryfrontRenderer } from "./orchestrator/ssr.js";
export declare function createRenderer(options: RendererOptions): Promise<VeryfrontRenderer>;
