...
import { RendererLifecycle } from "./lifecycle.js";
...
export class VeryfrontRenderer {
    ...
    renderPage(slug, options) {
        ...
        return withSpan("renderer.renderPage", () => this.renderPipeline.renderPage(slug, mergedOptions), {
            "renderer.slug": slug,
        });
    }
    resolvePageData(slug, options) {
        ...
        return withSpan("renderer.resolvePageData", () => this.renderPipeline.resolvePageData(slug, mergedOptions), { "renderer.slug": slug });
    }
    getAllPages() {
