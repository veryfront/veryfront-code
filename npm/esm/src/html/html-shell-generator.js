...
import { extractCandidates, getDevStyles, getProductionStyles, getProjectCSS, } from "./styles-builder/index.js";
import { buildContentAttributes, buildImportMapJson, buildRootAttributes, shouldDisableLayout, } from "./utils.js";
...
async function generateHTMLShellPartsImpl(meta, options, params, props, contentForTailwind) {
    ...
    const candidates = new Set(options.projectClasses ?? []);
    ...
    const rootAttributes = buildRootAttributes(meta.slug || "", options.mode || "production", noLayout);
