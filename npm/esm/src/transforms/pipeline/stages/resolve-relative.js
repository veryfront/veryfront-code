import { blockExternalUrlImports, resolveRelativeImports, resolveRelativeImportsForSSR, resolveVeryfrontImports, } from "../../esm/path-resolver.js";
import { rendererLogger as logger } from "../../../utils/index.js";
import { isBrowser, isSSR } from "../context.js";
import { TransformStage } from "../types.js";
export const resolveRelativePlugin = {
    ...
    async transform(ctx) {
        ...
        if (isBrowser(ctx)) {
            return resolveRelativeImports(ctx.code, ctx.filePath, ctx.projectDir, ctx.moduleServerUrl);
        }
        return ctx.code;
    },
};
