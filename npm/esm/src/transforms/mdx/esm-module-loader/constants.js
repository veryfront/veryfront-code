...
export const FRAMEWORK_ROOT = new URL("../../../..", globalThis[Symbol.for("import-meta-ponyfill-esmodule")](import.meta).url).pathname;
export const LOG_PREFIX_MDX_LOADER = "[mdx-loader]";
export const LOG_PREFIX_MDX_RENDERER = "[mdx-renderer]";
export const JSX_IMPORT_PATTERN = /import\s+([^'"]+)\s+from\s+['"]file:\/\/([^'"]+\.(js|jsx|ts|tsx))['"];?/g;
