...
import { extractFrontmatter, extractMetadata } from "./module-loader/metadata-extractor.js";
export function parseMDXCode(compiledCode) {
    ...
    const cleanedCode = compiledCode
        ...
        .replace(/^\s*const\s+(React|Fragment|Fragment2|jsx|jsx2|jsxs|jsxs2)\s*=.*?;?\s*$/gm, ""); // Remove runtime declarations
