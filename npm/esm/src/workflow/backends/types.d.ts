...
export interface WorkflowBackend {
    ...
    publishEvent?(eventName: string, payload: unknown, options?: {
        runId?: string;
        workflowId?: string;
    }): Promise<void>;
...
export declare function hasQueueSupport(backend: WorkflowBackend): backend is WorkflowBackend & Required<Pick<WorkflowBackend, "enqueue" | "dequeue" | "acknowledge">>;
export declare function hasLockSupport(backend: WorkflowBackend): backend is WorkflowBackend & Required<Pick<WorkflowBackend, "acquireLock" | "releaseLock">>;
export declare function hasEventSupport(backend: WorkflowBackend): backend is WorkflowBackend & Required<Pick<WorkflowBackend, "publishEvent" | "subscribeEvents">>;
