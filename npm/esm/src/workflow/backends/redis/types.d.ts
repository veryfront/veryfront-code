...
export type { DenoRedisClient, DenoRedisModule, NodeRedisClient, NodeRedisModule, RedisAdapter, } from "../../../platform/adapters/redis/index.js";
 ...
 */
export type RedisBackendInternalConfig = Required<Pick<RedisBackendConfig, "prefix" | "streamKey" | "groupName" | "consumerName" | "debug">> & RedisBackendConfig;
