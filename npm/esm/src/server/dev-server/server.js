...
export class DevServer {
    ...
    async start() {
        ...
        const routeDiscovery = new RouteDiscovery(this.options.projectDir, this.adapter, this.router, this.appConfig);
        ...
        const requestHandler = new RequestHandler(this.options.projectDir, this.adapter, () => this._isReady, () => this.isDebug(), this.hmrServer, this.appConfig);
        this.requestHandler = requestHandler;
        await setupMiddleware(this.pipeline, this.appConfig, (req) => requestHandler.handleRequest(req), this.options.projectDir, this.adapter);
        ...
        const baseHandler = (req) => this.pipeline.execute(req, this.adapter.env.toObject());
    ...
    async setupFileWatchers() {
        ...
        this.fileWatchSetup = new FileWatchSetup(this.options.projectDir, this.adapter, this.hmrServer, routeDiscovery, debounceMs, () => this.requestHandler?.invalidateUniversalHandler());
