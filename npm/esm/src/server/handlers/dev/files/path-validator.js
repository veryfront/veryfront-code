import { fromBase64Url, isAbsolutePath, isWithinDirectory, joinPath, normalizePath, } from "../../../../utils/path-utils.js";
...
export async function validateDevFilePath(encoded, ctx) {
