import { HTTP_CONTENT_TYPE_IMAGE_GIF, HTTP_CONTENT_TYPE_IMAGE_ICO, HTTP_CONTENT_TYPE_IMAGE_JPEG, HTTP_CONTENT_TYPE_IMAGE_PNG, HTTP_CONTENT_TYPE_IMAGE_SVG, HTTP_CONTENT_TYPE_IMAGE_WEBP, } from "../../../utils/index.js";
...
export function getContentTypeForPath(path) {
...
export function isCompressible(contentType) {
    if (contentType.startsWith("text/"))
        return true;
    if (COMPRESSIBLE_PATTERNS.some((p) => contentType.includes(p)))
        return true;
    if (COMPRESSED_PATTERNS.some((p) => contentType.includes(p)))
        return false;
    return false;
}
export function isCacheable(contentType) {
