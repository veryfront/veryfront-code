...
import { HTTP_OK, PRIORITY_HIGH_CLIENT_LOG } from "../../../utils/constants/index.js";
...
export class ClientLogHandler extends BaseHandler {
    metadata = {
        ...
        priority: PRIORITY_HIGH_CLIENT_LOG,
    ...
    async handle(req, ctx) {
        ...
        return this.respond(ResponseBuilder.json({ ok: true }, req, {
    ...
    handleParseError(e, body) {
        ...
        serverLogger.error("[ClientLogHandler] Raw body received (first 500 chars):", body.slice(0, 500));
