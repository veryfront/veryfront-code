...
import { HTTP_OK } from "../../../utils/constants/index.js";
...
const PRIORITY_MARKDOWN_PREVIEW = 900;
export class MarkdownPreviewHandler extends BaseHandler {
    ...
    async renderMarkdown(req, ctx, filePath, url) {
        try {
            ...
            const studioScript = studioEmbed
                ? `<script>${generateStudioBridgeScript({
