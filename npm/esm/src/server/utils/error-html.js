 ...
 */
function generateMinimalErrorHtml(statusCode, title, message, pathname) {
...
export const ErrorPages = {
    notFound: (pathname) => generateErrorHtml({
        statusCode: 404,
        title: "Not Found",
        message: pathname
