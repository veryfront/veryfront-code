import type { OnToolCallArg, ToolState, UIMessage, UIMessagePart } from "../types.js";
...
export type OrderedToolCall = StreamingToolCall & {
    order: number;
};
export type OrderedReasoning = StreamingReasoning & {
    order: number;
};
