...
export type { AppRouteMatch, Handler, HandlerContext, HandlerMetadata, HandlerPriority, HandlerResult, MiddlewareFunction, MiddlewareFunction as ServerMiddlewareFunction, ParsedDomain, RouteHandlerModule, RoutePattern, RouteRegistryConfig, SecurityConfig, } from "./server.js";
export type { ClientComponentMeta, ComponentAnalysis, ComponentType, RSCHydratorOptions, RSCNode, RSCPayload, RSCRendererOptions, } from "./rsc.js";
...
export interface ScriptPageModule {
    render?: (ctx: PageContext) => MaybePromise<string | dntShim.Response | {
        html: string;
        frontmatter?: MDXFrontmatter;
        meta?: MDXFrontmatter;
    }>;
    default?: ((ctx: PageContext) => MaybePromise<string | dntShim.Response>) | string;
    html?: string;
    generateMetadata?: (ctx: PageContext) => MaybePromise<Record<string, unknown>>;
}
export interface Bundler {
    bundleTsxSourceToComponent?: (content: string, filePath: string, projectDir: string) => Promise<React.ComponentType>;
}
...
export type { BrowserTargets, CriticalCSSResult, CSSBundle, CSSOptimizationOptions, CSSOptimizationStrategy, CSSOptimizerStats, CSSProcessingResult, LightningCSSModule, LightningCSSTransformOptions, LightningCSSTransformResult, SelectorExtractionResult, } from "../build/asset-pipeline/css-optimizer/types/index.js";
