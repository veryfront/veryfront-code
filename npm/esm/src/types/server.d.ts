...
export type MiddlewareFunction = (req: dntShim.Request, ctx: HandlerContext, next: () => Promise<dntShim.Response>) => Promise<dntShim.Response>;
export interface RouteRegistryConfig {
    debug?: boolean;
    enableMetrics?: boolean;
}
export type RouteHandler = (req: dntShim.Request, ctx: {
