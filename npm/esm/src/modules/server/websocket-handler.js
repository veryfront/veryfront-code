...
import { HMR_CLOSE_MESSAGE_TOO_LARGE, HMR_CLOSE_NORMAL, HMR_CLOSE_RATE_LIMIT, } from "../../utils/index.js";
export function setupWebSocketHandlers(socket, context) {
...
export async function closeAllConnections(clients, rateLimiter) {
    if (clients.size === 0) {
        return;
    }
