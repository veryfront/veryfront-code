...
const globalTmpDirs = new Map();
const projectTmpDirs = new Map();
/**
...
export async function getGlobalTmpDir() {
...
export async function getProjectTmpDir(projectId) {
...
export function resetGlobalTmpDir() {
    globalTmpDirs.clear();
