...
function transformAllComponents(components, projectDir, adapter, transformOpts) {
...
async function importUnifiedComponents(tmpDir, components) {
...
async function cleanupTempDirectory(tmpDir, adapter) {
    try {
