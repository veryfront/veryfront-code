...
export { uploadsCommand } from "./uploads/index.ts";
export { filesCommand } from "./files/index.ts";
export { knowledgeCommand } from "./knowledge/index.ts";
...
export { workflowCommand } from "./workflow/index.ts";
