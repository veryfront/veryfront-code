...
export const pullHelp: CommandHelp = {
  ...
  notes: [
    ...
    "A successful pull stores the canonical project link; package.json and tsconfig.json come only from the selected source or existing target",
    "Pull confirms before writing managed files, pruning files, or creating the project link; use --yes to skip",
    "Pull never invents dependency or compiler configuration; --dry-run reports the planned project-link write",
