...
Deno.test("restarted Anthropic request is byte-equivalent to uninterrupted replay", () => {
...
Deno.test("restarted OpenAI Responses request is byte-equivalent to uninterrupted replay", () => {
  const providerBlocks: RuntimeProviderBlock[] = [
    {
      type: "provider-block",
