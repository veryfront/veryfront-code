...
function freezeSelectorPolicy(
  ...
  return policy.kind === "allowlist"
    ? Object.freeze({
      kind: "allowlist",
      entries: Object.freeze([...policy.entries]),
    })
...
export function createNoneSkillSelectorSnapshot<TDefinition>(
  ...
  return Object.freeze({
    ...
    allowedSkillIds: Object.freeze([]),
    skillSourcePaths: Object.freeze({}),
    unresolvedEntries: Object.freeze([]),
  });
}
...
function buildSnapshot<TDefinition>(
  ...
  return Object.freeze({
    ...
    allowedSkillIds: Object.freeze(
      frozenDefinitions.map((definition) => getId(definition)),
    ),
    skillSourcePaths: Object.freeze(skillSourcePaths),
    unresolvedEntries: Object.freeze(
      unresolvedEntries.map((entry) => Object.freeze({ ...entry })),
    ),
  });
}
