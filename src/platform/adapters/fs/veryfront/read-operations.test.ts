...
describe("ReadOperations", () => {
  ...
  describe("readFileBytesWithinLimit", () => {
    ...
    it("resolves extensionless candidates without inspecting cached file-list content", async () => {
      ...
      const readOps = createReadyReadOps(
        ...
        () => {
          fileListCalls++;
          throw new Error("unbounded file-list content must not be inspected");
        },
      );
