...
Deno.test("rehype-utils - rehypePreserveNodeIds handles elements without data", () => {
  const element = createElement("p");
  const tree = createTree(element);
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to paragraph", () => {
  const element = createElement("p");
  const tree = createTree(element);
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to h1", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to h2", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to h3", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to anchor", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to inline code", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to code block", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to blockquote", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to ul", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to ol", () => {
...
Deno.test("rehype-utils - rehypeAddClasses adds classes to li", () => {
...
Deno.test("rehype-utils - rehypeAddClasses converts string className to array", () => {
...
Deno.test("rehype-utils - rehypeAddClasses preserves existing array className", () => {
  const element = createElement("p", { className: ["existing-class"] });
  const tree = createTree(element);
...
Deno.test("rehype-utils - rehypeAddClasses ignores unknown elements", () => {
...
Deno.test("rehype-utils - rehypeMdxComponents adds data attribute to MDX component", () => {
  const mdxComponent = {
...
Deno.test("rehype-utils - rehypeMdxComponents handles multiple components", () => {
  const mdxComponent1 = {
    type: "mdxJsxFlowElement",
    name: "Button",
  };
...
Deno.test("rehype-utils - rehypeMdxComponents initializes data if missing", () => {
  const mdxComponent = {
    type: "mdxJsxFlowElement",
    name: "Button",
  };
...
Deno.test("rehype-utils - rehypeMdxComponents preserves existing data", () => {
  const mdxComponent = {
    type: "mdxJsxFlowElement",
    name: "Button",
    data: {
...
Deno.test("rehype-utils - rehypeMdxComponents preserves existing hProperties", () => {
  const mdxComponent = {
    type: "mdxJsxFlowElement",
    name: "Button",
    data: {
...
Deno.test("rehype-utils - rehypeAddClasses handles nested elements", () => {
