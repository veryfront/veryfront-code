...
describe("build/compiler/mdx-compiler/mdx-processor", () => {
  describe("compileMDX", () => {
    ...
    it("extracts actual module imports without matching fenced examples", async () => {
      const content = [
        "```js",
        'import Fake from "fake-example"',
        "```",
        "",
      ...
      assertEquals(result.imports.includes("react"), true);
      assertEquals(result.imports.includes("fake-example"), false);
    });
