...
function usageRows(usage: EvalUsage | undefined): Array<[string, string]> {
  ...
  const rows: Array<[string, string]> = [
    ...
    ["Cache creation input tokens", numberCell(usage.cacheCreationInputTokens)],
    ["Cache read input tokens", numberCell(usage.cacheReadInputTokens)],
    ["Cache write input tokens", numberCell(usage.cacheWriteInputTokens)],
    ["Effective input tokens", numberCell(usage.effectiveInputTokens)],
