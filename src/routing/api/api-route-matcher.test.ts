...
import { assertEquals, assertExists, assertStrictEquals } from "@veryfront/testing/assert";
...
describe("DynamicRouter", () => {
  ...
  describe("Additional edge cases", () => {
    it("handles empty parameter values", () => {
      ...
      // This won't match because dynamic segments can't be empty
      const match = router.match("/search//filter");
      assertEquals(match, null);
    });
