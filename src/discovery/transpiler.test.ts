...
describe("discovery/transpiler", { sanitizeOps: false, sanitizeResources: false }, () => {
  ...
  describe("readProjectRegistrySources", () => {
    ...
    it("matches the workspace patterns npm's own globs accept", async () => {
      ...
      assertEquals(await declaring(["apps/!(a|)a"], `${PROJECT}/apps/aa`), "apps/aa");
      ...
      assertEquals(await declaring(["apps/aa!(a|*)"], `${PROJECT}/apps/aa`), "");
      assertEquals(
        await declaring(["apps/*?(a|b)*"], `${PROJECT}/apps/x`),
        "",
      );
      assertEquals(
        await declaring(["apps/*!(a|b)*"], `${PROJECT}/apps/x`),
      ...
      assertEquals(
        await declaring(["apps/@(a|b)*?(a|b)a"], `${PROJECT}/apps/aa`),
        "",
      );
      assertEquals(
