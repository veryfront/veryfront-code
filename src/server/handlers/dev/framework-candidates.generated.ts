...
export const FRAMEWORK_CANDIDATES: readonly string[] = [
  ...
  "assertDuration(record.duration",
  ...
  "item.select",
  "item.select();",
  "item.setContentId(realizedId),",
  "item.setTriggerId(realizedId),",
  "item.size",
  "item.state",
  "item.tabIndex",
  "item.text",
  ...
  "setHasScrolled]",
  "setHost(globalThis.document?.body",
  "setHost]",
