...
export const FRAMEWORK_CANDIDATES: readonly string[] = [
  ...
  "assertEquals((latest",
  "assertEquals((text",
  "assertEquals(Object.keys(uiModule).sort(),",
  "assertEquals(await",
  ...
  "assertEquals(uiModule.ColorModeProvider,",
  "assertEquals(uiModule.cva,",
  "assertEquals(uiModule.cx,",
  "assertEquals(uiModule.useColorMode,",
  ...
  "colorClass;",
  "colorModeModule",
  "colorModeModule.ColorModeProvider);",
  "colorModeModule.useColorMode);",
  ...
  "react/components/ui/color-mode",
  ...
  "veryfront/react/components/chat/chat-tokens-style.tsx",
