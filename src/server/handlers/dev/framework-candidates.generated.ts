...
export const FRAMEWORK_CANDIDATES: readonly string[] = [
  ...
  "prose-hr:border-[var(--edge-medium)]",
  "prose-inline-code:bg-[var(--accent)]",
  "prose-inline-code:font-medium",
  "prose-inline-code:font-mono",
  "prose-inline-code:px-1",
  "prose-inline-code:py-0.5",
  "prose-inline-code:rounded-[var(--radius-xs)]",
  "prose-inline-code:text-[var(--foreground)]",
  "prose-pre:bg-[var(--secondary)]",
  "prose-pre:rounded-[var(--radius-lg)]",
