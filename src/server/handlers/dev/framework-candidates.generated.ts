...
export const FRAMEWORK_CANDIDATES: readonly string[] = [
  ...
  "React.useState<MermaidRenderState>();",
  ...
  "createRetryableModuleLoader,",
  "createRetryableModuleLoader<T>(",
  "createSerialAsyncExecutor",
  "createSerialAsyncExecutor():",
  "createSerialAsyncExecutor();",
  ...
  "execute<T>(operation:",
  "executeCommand",
  "executeMermaidRender",
  "executeMermaidRender(async",
  ...
  "mermaid",
  "mermaid),",
  "mermaid-${React.useId().replace(/[^A-Za-z0-9_-]/g,",
  "mermaidModule",
  "mermaidModule.default.initialize({",
  "mermaidModule.default.render(id,",
  "mermaidModuleLoader",
  "mermaidModuleLoader.load();",
  "mermaidTheme",
  "mermaidTheme:",
  "message",
  "message's",
  ...
  "react/components/ui/code-block-runtime",
