...
Deno.test("projects handler rejects non-read methods before consuming route work", async () => {
  let cancelled = false;
...
Deno.test("projects handler gives HEAD the GET status and headers without a body", async () => {
