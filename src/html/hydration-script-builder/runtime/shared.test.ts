...
describe("hydration-script-builder/runtime/shared", () => {
  describe("normalizeRouteParams", () => {
    ...
    it("normalizes only own properties without prototype mutation", () => {
      const params = Object.create({ inherited: "ignored" }) as Record<
        string,
        string | string[]
      >;
      ...
      assertEquals(Object.keys(normalized), ["__proto__"]);
      assertEquals(Object.prototype.hasOwnProperty.call(normalized, "__proto__"), true);
      assertEquals(normalized["__proto__"], "safe/value");
