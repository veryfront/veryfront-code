...
const TOKENS_LIGHT = {
  ...
  "--alert-warning-border": "#F5BA67",
  "--alert-error-bg": "#ECD3D1",
  "--alert-error-border": "#E06E7B",
  "--alert-success-bg": "#D4E2D2",
  "--alert-success-border": "#6FB57C",
  "--alert-info-bg": "#E6E6E0",
  "--alert-info-border": "#ADADAA",
...
const TOKENS_DARK = {
  ...
  "--alert-warning-border": "color-mix(in oklch,var(--status-warning) 40%,var(--background))",
  "--alert-error-bg": "color-mix(in oklch,var(--status-error) 18%,var(--background))",
  "--alert-error-border": "color-mix(in oklch,var(--status-error) 40%,var(--background))",
  "--alert-success-bg": "color-mix(in oklch,var(--status-success) 18%,var(--background))",
  "--alert-success-border": "color-mix(in oklch,var(--status-success) 40%,var(--background))",
  "--alert-info-bg": "color-mix(in oklch,var(--status-info) 18%,var(--background))",
  "--alert-info-border": "color-mix(in oklch,var(--status-info) 40%,var(--background))",
