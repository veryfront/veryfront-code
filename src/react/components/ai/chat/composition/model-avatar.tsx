...
export function ModelAvatar(
  ...
  if (m.includes("anthropic") || m.includes("claude")) {
    return (
      <div
        className={cn(
          "mt-1 shrink-0 size-8 rounded-full bg-[#d97757] flex items-center justify-center shadow-sm",
          className,
        )}
      >
  ...
  return (
    <div
      className={cn(
        "mt-1 shrink-0 size-8 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center shadow-sm",
        className,
      )}
    >
