...
export function AttachmentPill({
  ...
  return (
    ...
    >
      {/* File type badge */}
      <span className={cn("inline-flex items-center justify-center rounded px-1 py-0.5 text-[9px] font-bold uppercase leading-none", colorClass)}>
        {ext || "?"}
      </span>
      ...
      {showPreview && attachment.preview && (
        <div className="absolute bottom-full left-0 mb-2 z-50 w-64 pointer-events-none">
          <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl shadow-lg p-3 text-left">
            <p className="text-[10px] font-medium text-neutral-500 dark:text-neutral-400 uppercase mb-1">Preview</p>
