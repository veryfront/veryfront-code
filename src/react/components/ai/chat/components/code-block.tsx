...
export function RichCodeBlock({
  ...
  if (inline) {
    return (
      <code className={cn("bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-sm font-mono", className)}>
        {code}
      </code>
    );
  }
  ...
  return (
    <div className={cn("my-4 rounded-xl overflow-hidden border border-neutral-200 dark:border-neutral-800", className)}>
