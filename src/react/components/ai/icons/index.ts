/**
 * Icons for AI Components
 *
 * Lucide-style SVG icons used throughout the AI chat components.
...
/** Circle icon - represents pending/unknown state */
...
/** Clock icon - represents time/waiting state */
...
/** X circle icon - represents error/failure */
...
/** Wrench icon - represents tools/actions */
...
/** Chevron down icon - represents expand/collapse */
...
/** Message square icon - represents chat/messages */
...
/** Arrow down icon - represents scroll down */
...
/** Send icon - represents send message action */
...
/** Stop icon - represents stop/cancel action */
...
/** Refresh icon - represents retry/reload action */
...
/** Copy icon - represents copy to clipboard action */
...
/** Check icon - represents confirmed/done state */
