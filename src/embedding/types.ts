...
// ---------------------------------------------------------------------------
// Upload Store compatibility aliases
// ---------------------------------------------------------------------------

/** @deprecated Use `RagDocumentMeta`. */
export type UploadMeta = RagDocumentMeta;

/** @deprecated Use `RagChunk`. */
...
/** @deprecated Use `RagStoreData`. */
export interface UploadStoreData {
  uploads: UploadMeta[];
  chunks: StoredChunk[];
}

/** @deprecated Use `RagStoreConfig`. */
export type UploadStoreConfig = RagStoreConfig;

/** @deprecated Use `RagSearchResult`. */
export interface UploadSearchResult extends RagSearchResult {
  uploadId: string;
}

/** @deprecated Use `RagSearchOptions`. */
export type UploadSearchOptions = RagSearchOptions;

/** @deprecated Use `RagStore`. */
export interface UploadStore extends RagStore {
