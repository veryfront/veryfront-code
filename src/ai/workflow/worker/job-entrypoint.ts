 ...
 * import { RedisBackend } from "veryfront/ai/workflow";
 * import { WorkflowExecutor } from "veryfront/ai/workflow";
 * import { runWorkflowJob } from "veryfront/ai/workflow/worker";
 ...
 * ```typescript
 * // job-main.ts
 * import { createJobEntrypoint } from "veryfront/ai/workflow/worker";
 * import { workflows } from "./workflows.ts";
 *
