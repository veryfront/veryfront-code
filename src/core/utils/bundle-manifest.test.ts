...
Deno.test("InMemoryBundleManifestStore - basic operations", async () => {
...
Deno.test("InMemoryBundleManifestStore - TTL expiration", async () => {
  const store = new InMemoryBundleManifestStore();
...
Deno.test("InMemoryBundleManifestStore - source indexing", async () => {
  const store = new InMemoryBundleManifestStore();
...
Deno.test("InMemoryBundleManifestStore - delete bundle", async () => {
  const store = new InMemoryBundleManifestStore();
...
Deno.test("InMemoryBundleManifestStore - clear all", async () => {
  const store = new InMemoryBundleManifestStore();
...
Deno.test("InMemoryBundleManifestStore - statistics", async () => {
  const store = new InMemoryBundleManifestStore();
...
Deno.test("computeContentHash - generates consistent hash", async () => {
