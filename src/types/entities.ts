...
/** Returns whether a parsed value is a plain frontmatter record. */
export function isFrontmatterRecord(value: unknown): value is Frontmatter {
...
/**
 * Copies a plain parsed record and removes values that violate known frontmatter fields.
 * Unknown fields are preserved for application-specific metadata.
 */
