...
import {
  ...
  getCLIAgents,
  getIDEAgents,
} from "../app/core/agents.ts";
import { spawnAgent, waitForExit } from "../app/core/pty.ts";
import { loadConfig, savePreferences } from "../app/core/config.ts";
import type { CodingAgentDef } from "../app/core/types.ts";
import { brand, dim, error, success } from "../ui/colors.ts";
