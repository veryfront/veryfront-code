...
export const COMMANDS: CommandRegistry = {
  ...
  issues: {
    ...
    examples: [
      ...
      "veryfront issues create --type task --milestone PLAN-1234567-abc123",
      ...
      "veryfront issues edit ISSUE-1234567-def456 --delete",
    ],
    notes: [
      "Just 4 commands (GitHub CLI inspired):",
      "  • create          - Create new issue",
      "  • list            - List issues (kanban board view)",
      "  • view <id>       - View issue details",
      "  • edit <id>       - Edit or delete issue (use --delete flag)",
      "",
      "File-based workflow:",
      "  • All issues stored in issues/ folder as markdown files",
      "  • Each file has YAML frontmatter (metadata) + markdown body (content)",
      "  • Edit files directly in your editor or use CLI",
      "  • Git-friendly, version-controlled, AI-native",
      "",
      "Spec-driven development:",
      "  • Everything is a file - specs/plans/RFCs are issues with type=plan or type=rfc",
      "  • Write spec → Break into tasks → Link tasks to spec via --milestone",
      "  • Example: veryfront issues create --type plan --title 'Auth System'",
      "  • Then: veryfront issues create --type task --milestone PLAN-xxx",
      "",
      "For AI agents:",
      "  • Read: Parse .md files in issues/ folder",
      "  • Create: Write new .md file with frontmatter + content",
      "  • Update: Modify frontmatter fields (status, priority, etc.)",
      "  • Standard format: YAML frontmatter + markdown body",
      "  • Spec-driven: Plans are issues with type=plan, link tasks via milestone field",
      "",
      "File format:",
      "  ---",
      "  id: ISSUE-123",
