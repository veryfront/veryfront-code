...
export default tool({
  ...
  inputSchema: z.object({
    workspaceIds: z.array(z.string()).optional().describe("Optional list of workspace IDs to filter boards"),
    limit: z.number().min(1).max(100).default(50).describe("Maximum number of boards to return"),
