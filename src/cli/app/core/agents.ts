...
import type { AgentSession, CodingAgentDef, CodingAgentState } from "./types.ts";
import { createCodingAgentState } from "./types.ts";
...
export async function isCommandAvailable(command: string): Promise<boolean> {
  ...
  try {
    ...
    const process = new Deno.Command(checkCmd, {
      args: [cmdName],
      stdout: "null",
      stderr: "null",
    });
