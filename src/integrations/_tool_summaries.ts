...
export const historicalToolSummaries: Record<string, IntegrationEndpointHistoricalSummary> = {
  ...
  "front__list_conversation_messages": {
    ...
    "omitted":
      "full message bodies, attachments, recipient objects, and provider-specific payload fields",
  },
  ...
  "hetzner__list_servers": {
    ...
    "outputFields": [{ "name": "meta", "kind": "object" }],
    "omitted":
      "network interfaces, image and server type details, and provider-specific payload fields",
  },
