...
const RUN_EVENT_WIRE_NAMES = {
  ...
  AGENT_RUN_RUNTIME_INVOKE_RETRIED: "AgentRunRuntimeInvokeRetried",
  AGENT_RUN_CONTEXT_COMPACTED: "AgentRunContextCompacted",
  AGENT_RUN_TOOL_EXPOSURE_CHECKPOINTED: "AgentRunToolExposureCheckpointed",
  AGENT_RUN_PROVIDER_REPLAY_CHECKPOINTED: "AgentRunProviderReplayCheckpointed",
  AGENT_RUN_PROVIDER_REPLAY_TURN_STARTED: "AgentRunProviderReplayTurnStarted",
  AGENT_RUN_PROVIDER_REPLAY_TURN_FINISHED: "AgentRunProviderReplayTurnFinished",
  AGENT_RUN_MODEL_CALL_CONTEXT_RECORDED: "AgentRunModelCallContextRecorded",
  AGENT_RUN_CONTROL_PLANE_DISPATCH_ACCEPTED: "AgentRunControlPlaneDispatchAccepted",
  AGENT_RUN_INVOKE_AGENT_BILLING_MODE_RETAINED: "AgentRunInvokeAgentBillingModeRetained",
  AGENT_RUN_BILLING_USAGE_RETAINED: "AgentRunBillingUsageRetained",
