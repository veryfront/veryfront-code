...
Deno.test("npm runtime helper contract accepts the emitted DNT helper set", async () => {
...
Deno.test("npm runtime helper contract rejects unrecognized package-root imports", async () => {
  const esmRoot = await createEmittedPackage([
    "../../_dnt.shims.js",
    "../../_dnt.polyfills.js",
    "../../deno.js",
...
Deno.test("npm runtime helper contract rejects missing imported helpers", async () => {
  const esmRoot = await createEmittedPackage([
    "../../_dnt.shims.js",
    "../../_dnt.polyfills.js",
    "../../deno.js",
...
Deno.test("npm runtime helper contract rejects stale expected helpers", async () => {
  const esmRoot = await createEmittedPackage([
    "../../_dnt.shims.js",
    "../../_dnt.polyfills.js",
  ]);
...
Deno.test("npm runtime helper contract rejects relative imports outside the ESM package", async () => {
  const esmRoot = await createEmittedPackage([
    "../../../outside.js",
  ]);
