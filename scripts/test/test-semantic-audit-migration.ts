...
export const TEST_SEMANTIC_AUDIT_MIGRATION_ENTRIES:
  readonly SemanticDispositionEntry[] = Object.freeze([
    ...
    entry("cli/auth/auth.integration.test.ts", ["network"], {
      "disposition": "integration-relocation",
      "owner": "cli",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("cli/commands/dev/dev-output.integration.test.ts", ["process"], {
      "disposition": "integration-relocation",
      "owner": "cli",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("cli/commands/doctor/server-checks.test.ts", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "cli",
      "rationale":
    ...
    entry("cli/shared/runtime-auth.test.ts", ["filesystem-write"], {
      "disposition": "integration-relocation",
      "owner": "cli",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("cli/utils/git.test.ts", ["filesystem-write", "process"], {
      "disposition": "integration-relocation",
      "owner": "cli",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("extensions/ext-css-tailwind/src/index.test.ts", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "extensions-templates",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry(
      ...
      ["browser"],
      {
        ...
        "rationale":
          "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
        "destination":
          "tests/integration/semantic-unit-boundary/extensions/ext-dev-ui-react/src/browser-bundle.test.ts",
        "removalPr": "PR 4e",
      },
    ),
    ...
    entry("src/agent/project/agent-runtime.test.ts", ["filesystem-write"], {
      "disposition": "integration-relocation",
      "owner": "agent-runtime",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/agent/react/use-chat/use-chat.csrf.test.tsx", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "agent-runtime",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/agent/react/use-chat/use-chat.status.test.tsx", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "agent-runtime",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/discovery/import-rewriter.test.ts", ["filesystem-write"], {
      "disposition": "integration-relocation",
      "owner": "core-runtime",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/embedding/embedding.test.ts", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "data-runtime",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/eval/datasets.test.ts", ["filesystem-write"], {
      "disposition": "integration-relocation",
      "owner": "core-runtime",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/extensions/manifest-reader.test.ts", ["filesystem-write"], {
      "disposition": "integration-relocation",
      "owner": "core-runtime",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/integrations/remote-tools.test.ts", ["filesystem-read"], {
      "disposition": "hermetic-unit",
      "owner": "data-runtime",
      "rationale":
        "Reads checked-in repository fixtures or contract files without mutating process, network, or external runtime state.",
    ...
    entry("src/knowledge/index.test.ts", ["filesystem-read", "network"], {
      "disposition": "integration-relocation",
      "owner": "data-runtime",
      "rationale":
    ...
    entry("src/modules/server/module-transform.test.ts", ["process"], {
      "disposition": "replaceable-fake",
      "owner": "build-rendering",
      "rationale":
        "Depends on or mutates process-global environment/runtime state and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/provider/local/local-provider.test.ts", ["process"], {
      "disposition": "integration-relocation",
      "owner": "provider-runtime",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/proxy/handler.test.ts", ["process"], {
      "disposition": "replaceable-fake",
      "owner": "server-routes",
      "rationale":
        "Depends on or mutates process-global environment/runtime state and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/proxy/websocket-client.test.ts", ["server"], {
      "disposition": "integration-relocation",
      "owner": "server-routes",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/react/components/chat/chat-agent-picker.test.tsx", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "core-runtime",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/react/components/chat/hooks-coverage.test.tsx", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "core-runtime",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/rendering/client/router.test.ts", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "build-rendering",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/routing/client/page-loader.test.ts", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "server-routes",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/security/sandbox/telemetry-redaction.test.ts", ["process"], {
      "disposition": "integration-relocation",
      "owner": "security-filesystem",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/server/project-env/hosted-authorization.test.ts", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "server-routes",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/testing/cwd.test.ts", ["filesystem-read", "filesystem-write"], {
      "disposition": "integration-relocation",
      "owner": "core-runtime",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/transforms/pipeline/index.test.ts", ["process"], {
      "disposition": "replaceable-fake",
      "owner": "core-runtime",
      "rationale":
        "Depends on or mutates process-global environment/runtime state and cannot run safely beside concurrent unit tests.",
    ...
    entry("src/utils/logger/serialization.test.ts", ["process"], {
      "disposition": "integration-relocation",
      "owner": "config-tooling",
      "rationale":
        "Exercises filesystem mutation, process, server, network, browser, or multi-component runtime behavior outside the colocated unit boundary.",
    ...
    entry("src/workflow/react/use-workflow-start.test.tsx", ["network"], {
      "disposition": "replaceable-fake",
      "owner": "agent-tools",
      "rationale":
        "Mutates the process-global fetch boundary and cannot run safely beside concurrent unit tests.",
