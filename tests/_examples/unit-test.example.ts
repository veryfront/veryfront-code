...
describe("Example Unit Test - Stateful Class", () => {
  ...
  it("should handle multiple operations", () => {
    ...
    assertEquals(
      counter.getValue(),
      1,
      "Counter should be 1 after increment, increment, decrement",
    );
  });
...
describe("Example Unit Test - Async Operations", () => {
  ...
  it("should complete within time budget", { timeout: TEST_TIMEOUTS.UNIT }, async () => {
...
describe("Example Unit Test - Error Handling", () => {
  ...
  it("should divide numbers correctly", () => {
    assertEquals(divide(10, 2), 5, "10 divided by 2 should equal 5");
  });
