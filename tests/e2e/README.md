...
```bash
npx playwright test tests/e2e/smoke.playwright.ts --config=tests/e2e/playwright.config.cjs
npx playwright test tests/e2e/ssr.playwright.ts --config=tests/e2e/playwright.config.cjs
npx playwright test tests/e2e/navigation.playwright.ts --config=tests/e2e/playwright.config.cjs
