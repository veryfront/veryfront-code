/**
 * Test: 002.5 Registry Isolation
 *
 * Validates the fix for issue 002.5 from the architecture audit:
 * - All 6 project-scoped registries are isolated
 * - Tools, agents, prompts, workflows, resources, providers are isolated
 * - Projects cannot see or access other projects' registered resources
 *
...
describe("002.5 Registry Isolation", () => {
  beforeEach(() => {
    clearAllRegistries();
  });
